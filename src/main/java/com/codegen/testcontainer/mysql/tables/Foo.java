...
import com.codegen.testcontainer.mysql.tables.Bar.BarPath;
...
public class Foo extends TableImpl<FooRecord> {
    ...
    public UniqueKey<FooRecord> getPrimaryKey() {
        return Keys.KEY_FOO_PRIMARY;
    }

    private transient BarPath _bar;

    /**
     * Get the implicit to-many join path to the <code>test.bar</code> table
     */
    public BarPath bar() {
        if (_bar == null)
            _bar = new BarPath(this, null, Keys.FK_FOO_BAR.getInverseKey());
