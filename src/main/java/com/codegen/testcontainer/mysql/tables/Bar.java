 ...
 */
package com.codegen.testcontainer.mysql.tables;


import com.codegen.testcontainer.mysql.DefaultSchema;
import com.codegen.testcontainer.mysql.Keys;
import com.codegen.testcontainer.mysql.tables.Foo.FooPath;
...
public class Bar extends TableImpl<BarRecord> {
    ...
    /**
     * The reference instance of <code>bar</code>
     */
    ...
    /**
     * The column <code>bar.bar_name</code>.
     */
    public final TableField<BarRecord, String> BAR_NAME = createField(DSL.name("bar_name"), SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>bar.foo_id</code>.
     */
    ...
    /**
     * Get the implicit join path to the <code>test.foo</code> table.
     */
    public FooPath foo() {
        if (_foo == null)
